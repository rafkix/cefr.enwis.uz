                ...
                <div className="container mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
                    <div className="flex items-center gap-2 md:gap-6">
                        <Button
                            ...
                            className="text-slate-500 font-black uppercase tracking-widest text-[9px] md:text-[10px] hover:text-blue-600 px-2"
                        >
                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-200">
                            ...
                            <div className="hidden xxs:block">
                                <h1 className="text-sm md:text-lg font-black tracking-tighter uppercase leading-none">
                                    Reading <span className="text-blue-600 italic">Vault</span>
                                </h1>
                    ...
                    <div className="relative hidden md:block w-64">
                        ...
                        <Input
                            ...
                            className="pl-9 h-10 bg-slate-50/50 border-slate-100 rounded-xl text-xs font-medium focus:ring-blue-500/20"
                        />
                    </div>
                </div>
            ...
            <main className="container mx-auto px-4 md:px-6 py-8 md:py-12 max-w-5xl">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-12 gap-6">
                    ...
                    <div className="flex items-center gap-3 text-slate-400 text-[9px] md:text-[10px] font-black uppercase tracking-widest">
                        ...
                        <span className="text-blue-600 italic">CEFR Standard</span>
                    </div>
                </div>
                                ...
                                >
                                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                        ...
                                        <div className="shrink-0 pt-2 lg:pt-0">
                                            {isUnlocked ? (
                                                <Button className="w-full lg:w-auto h-12 md:h-14 px-8 rounded-xl md:rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-[9px] md:text-[10px] group-hover:scale-105 transition-all shadow-lg shadow-blue-100">
