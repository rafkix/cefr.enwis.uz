...
export default function ListeningResultPage() {
    ...
    useEffect(() => {
        if (params.id) {
            getListeningResultDetailAPI(Number(params.id))
    ...
    if (loading) return (
        <div className="h-[60vh] flex flex-col items-center justify-center">
            <Loader2 className="w-10 h-10 animate-spin text-[#17776A] mb-4" />
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20 animate-in fade-in duration-700">
            <Link href="/dashboard/result" className="inline-flex items-center gap-2 text-slate-500 hover:text-[#17776A] mb-8 font-bold transition-colors group">
            ...
            <div className="bg-white rounded-[40px] border border-slate-100 shadow-2xl overflow-hidden mb-10">
                <div className="bg-gradient-to-br from-[#17776A] to-[#136358] p-10 text-white">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                <span className="bg-white/20 px-3 py-1 rounded-lg text-[10px] font-black uppercase">Listening</span>
                            ...
                            <p className="text-emerald-100 font-medium italic">Test ID: {summary.exam_id}</p>
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-slate-100 py-6 bg-slate-50/50">
                    ...
                    <StatItem icon={<BarChart3 size={18} className="text-blue-500"/>} label="Foiz" value={`${Math.round((summary.correct_answers / summary.total_questions) * 100)}%`} />
            ...
            <div className="bg-white rounded-[35px] border border-slate-100 p-8 shadow-xl shadow-slate-100/50">
                <h2 className="text-xl font-black text-slate-800 flex items-center gap-3 mb-8 uppercase">
                    <Target className="text-[#17776A]" /> Savollar tahlili
                </h2>
