...
interface Summary {
    exam_id: string;
    created_at: string;
    correct_answers: number; // Yoki raw_score (backendga qarab)
...
export default function ReadingResultPage() {
    ...
    useEffect(() => {
        if (resultId) {
            getReadingResultDetailAPI(Number(resultId))
                .then(res => {
                    if (res.data) {
                        setData(res.data)
                    } else if (res.summary) {
    ...
    // Foizni hisoblash (agar backend bermagan bo'lsa)
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20 px-4 pt-8 animate-in fade-in duration-700">
            ...
            {/* HEADER CARD (Reading uchun BLUE gradient) */}
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-8 relative z-10">
                        <div className="text-center md:text-left">
                            <div className="flex flex-wrap justify-center md:justify-start items-center gap-2 mb-4">
                                <span className="bg-white/20 backdrop-blur-md px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border border-white/10">Reading</span>
                            ...
                            <p className="text-blue-100 font-medium italic text-sm">Test ID: <span className="font-mono opacity-70">{summary.exam_id}</span></p>
                        </div>
                        ...
                        <div className="flex items-center gap-4 bg-white/10 p-6 rounded-[32px] backdrop-blur-md border border-white/20 shadow-lg">
                            ...
                            <div className="text-center px-4">
                                <p className="text-[10px] font-black uppercase opacity-70 mb-1 text-blue-100 tracking-wider">CEFR Ball</p>
