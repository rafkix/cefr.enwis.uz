...
const ADS = [
  ...
  },
  {
    ...
    color: '#FF5733',
    image:
      'https://images.unsplash.com/photo-1551288049-bbbda546697a?q=80&w=1000&auto=format&fit=crop',
    icon: <Star size={28} />,
    title: (
      <>
  ...
  return (
    <div className="fixed inset-0 w-full h-full flex flex-col lg:flex-row bg-white overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 lg:px-16 bg-white z-20 relative overflow-y-auto">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-[#17776A] text-2xl font-black tracking-tighter uppercase">
              ENWIS HUB
            </span>
          </div>
          ...
          <header className="mb-12">
            <h1 className="text-5xl font-black text-slate-800 leading-tight mb-4 tracking-tight">
              Xush kelibsiz
            </h1>
      ...
      <div className="hidden lg:flex w-[55%] h-full bg-[#0a0a0a] relative items-center justify-center overflow-hidden">
        <div
          className="absolute left-0 top-0 bottom-0 w-[150px] bg-white z-10"
              ...
              <div className="p-12 pt-0 flex flex-col">
                ...
                <div className="flex items-center justify-between pt-10 border-t border-white/5">
                  ...
                  <a
                    ...
                    className="h-14 px-8 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center gap-3 shadow-2xl shadow-black/40"
          ...
          <div className="flex gap-3 mt-10 justify-center">
            {ADS.map((_, i) => (
              <button
                ...
                style={{
                  backgroundColor: adIndex === i ? ADS[adIndex].color : undefined,
                }}
              />
            ))}
          </div>
