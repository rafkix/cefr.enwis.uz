...
function RegisterForm() {
  ...
  const getSocialQuery = () =>
    clientId ? `?client_id=${clientId}&redirect_uri=${redirectUri}&state=${state}` : ''
      ...
      <div className="w-full lg:w-[45%] h-full flex flex-col justify-center px-6 sm:px-12 md:px-20 lg:px-24 z-20 bg-white overflow-y-auto lg:overflow-hidden py-6 lg:py-0">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[#17776A] text-xl font-black tracking-tighter uppercase">
              ENWIS HUB
            </span>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            <div className="group relative">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 rounded-[18px] bg-slate-50 border-b-2 border-transparent focus:border-[#17776A] focus:bg-white outline-none transition-all font-semibold text-slate-700 text-sm"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="group relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-10 pr-4 rounded-[18px] bg-slate-50 border-b-2 border-transparent focus:border-[#17776A] focus:bg-white outline-none transition-all font-semibold text-slate-700 text-sm"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="group relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full h-12 pl-10 pr-10 rounded-[18px] bg-slate-50 border-b-2 border-transparent focus:border-[#17776A] focus:bg-white outline-none transition-all font-semibold text-slate-700 text-sm"
                  placeholder="Parol"
                  required
                />
                <button
            ...
            <div className="flex items-start gap-2 px-1">
              <input
                ...
                className="mt-1 w-4 h-4 accent-[#17776A]"
              />
              <span className="text-[10px] text-slate-400 font-medium">
                Men{' '}
                <Link href="/terms" className="text-[#17776A] font-bold underline">
                  Shartlar
                </Link>
                ga roziman.
              </span>
            ...
            <button
              ...
              className="w-full h-14 bg-[#17776A] text-white rounded-2xl font-bold shadow-lg shadow-[#17776A]/20 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {loading ? (
        ...
        >
          ...
          <div className="space-y-10">
            ...
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <span className="text-[10px] font-bold text-[#5CB9AD] uppercase tracking-[0.2em]">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-xl leading-relaxed font-medium">
                IELTS 7.5+, CEFR va Multilevel imtihonlari uchun akademik muhitga
                qo'shiling.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 p-5 rounded-[24px] bg-gradient-to-r from-white/5 to-transparent border border-white/5">
              ...
              <div>
                <div className="text-white font-bold text-sm text-left">
                  Professional Ta'lim
                </div>
                <div className="text-slate-500 text-xs text-left">
                  Xalqaro standartlar asosida darslar
                </div>
              </div>
            </div>
          </div>
