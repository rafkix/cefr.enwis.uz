...
type SkillColor = "blue" | "purple" | "orange" | "red"
        ...
        >
            ...
            {badge && (
                <div className="absolute right-0 top-0">
                    <div className="rounded-bl-xl rounded-tr-xl bg-blue-500 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-white">
                        {badge}
                    </div>
                </div>
            )}
