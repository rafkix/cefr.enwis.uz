...
14. Cultural Exchange Programs provides English courses combined with cultural immersion. Students live with host families and participate in cultural activities while learning English. The program emphasizes real-world communication in authentic cultural settings, preparing students for effective communication with English speakers worldwide.`,
    ...
    {
      id: 3,
      title: 'Part 3: The Ultimate blue Home',
      ...
      description_uz:
        "Matnni o'qing va har bir paragrafsiga to'g'ri sarlavhani tanlang.",
      passage: `The Ultimate blue Home
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: 'C',
              value: 'to criticize the lack of tolerance for travelling communities',
            },
            {
              label: 'D',
              value:
                'to highlight the current state of traditional travelling cultures',
            },
          ],
          correct_answer: 'D',
        },
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: 'D',
              value: 'The nature of the dialogue emphasises key elements of the film.',
            },
          ],
          correct_answer: 'D',
        },
