...
export const UZ_LABELS = {
  ...
  unanswered: "Javob berilmadi",
  instructions: "Ko'rsatmalar",
}

// Real IELTS Reading Exam with 3 Parts
export const SAMPLE_EXAM_1: ExamSet = {
  id: "1",
  title: "MuliLevel Reading Practice Test",
  title_uz: "MuliLevel O'qish Amaliyot Testi",
  cefr_level: "B2",
  duration_minutes: 60,
  language: "uz",
  parts: [
...
// Real IELTS Reading Exam with 3 Parts
export const SAMPLE_EXAM_2: ExamSet = {
  id: "1",
  title: "MuliLevel Reading Practice Test",
  title_uz: "MuliLevel O'qish Amaliyot Testi",
  cefr_level: "B2",
